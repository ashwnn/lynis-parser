...
A client side parser for .dat files created by Lynis (security audit tool for Linux based machines). You can optionally run AI analysis using Gemini with your own API key.
